...
export const COMPETENCY_TRACKS = Object.freeze([
  ...
  { id:'c-programming', title:'C Programming', modules:['C Fundamentals','Control Flow','Arrays','Functions & Modular Programming','Pointers','Structures, Unions & User-Defined Types','Dynamic Memory & Memory Management','File Handling','Strings','Advanced C'], activityModel:['Learn','Observe Code','Practice','Compile','Hidden-Test Challenge','Assessment'] },
