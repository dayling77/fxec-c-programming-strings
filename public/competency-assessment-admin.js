...
function render(){
 ...
 h+='</select></label><button id="caCreate" class="secondary">Create / Reset 5-Day Programme</button><button id="caRefresh" class="secondary">Refresh</button></div>';
...
function renderEditor(t){
 ...
 h+='<div class="caQuestionHead"><h4>Question Review & Assignment</h4><span>Edit every question before approval.</span></div><div id="caQuestions">'+(t.questions||[]).map((q,i)=>renderQuestion(q,i)).join('')+'</div>';
